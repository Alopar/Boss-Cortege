...
namespace BossCortege
{
    public class RaceManager : MonoBehaviour
    {
        ...
        #region HANDLERS
        private void SpawnStopHandler(SpawnStopInfo info)
        {
            StopAllSpawn();
        }
        ...
        private void OnEnable()
        {
            ...
            EventHolder<SpawnStopInfo>.AddListener(SpawnStopHandler, false);
        ...
        private void OnDisable()
        {
            ...
            EventHolder<SpawnStopInfo>.RemoveListener(SpawnStopHandler);
